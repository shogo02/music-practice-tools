...
function ToggleButton(props: ToggleButtonProps) {
  ...
  // TODO 後で水平方向の位置を揃える
    <div className="flex">
      <div>{falseText}</div>
      <div onClick={onClick} className={`${addClassName} bg-[#dedede] flex items-center h-5 w-10 rounded-full shadow-[inset_1px_1px_2px_#b5b5b5,inset_-1px_-1px_2px_#ffffff] cursor-pointer`}>
